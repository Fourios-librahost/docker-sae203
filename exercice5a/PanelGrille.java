...
public class PanelGrille extends JPanel implements ActionListener
{
	...
	public PanelGrille(Controleur ctrl)
	{
		 ...
		 * 
		 * for (int col=0 ; col < modele[0].length ; col++ ) if ( modele[0][col]
		 * != null && modele[0][col].startsWith ("fl_" ) ) { this.tabButton[col]
		 * =new JButton(new ImageIcon("./fl_bas.gif")); }
		 */
	...
	private String[][] getModele()
	{
		 ...
		 * 
		 * { {null, "fl_haut", "fl_haut", "fl_haut", "fl_haut", "fl_haut",
		 * "fl_haut", null }, {"fl_gauche", "val", "val", "val", "val", "val",
		 * "val", "fl_droite" }, {"fl_gauche", "val", "val", "val", "val",
		 * "val", "val", "fl_droite" }, {"fl_gauche", "val", "val", "val",
		 * "val", "val", "val", "fl_droite" }, {"fl_gauche", "val", "val",
		 * "val", "val", "val", "val", "fl_droite" }, {"fl_gauche", "val",
		 * "val", "val", "val", "val", "val", "fl_droite" }, {"fl_gauche",
		 * "val", "val", "val", "val", "val", "val", "fl_droite" }, {null,
		 * "fl_bas", "fl_bas", "fl_bas", "fl_bas", "fl_bas", "fl_bas", null } };
		 */
